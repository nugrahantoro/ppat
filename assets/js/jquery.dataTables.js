 ...
 * Version:     1.7.0
 * CVS:         $Id: jquery.dataTables.js,v 1.1 2015/06/25 05:10:39 didik Exp $
 * Description: Paginate, search and sort HTML tables
 * Author:      Allan Jardine (www.sprymedia.co.uk)
 * Created:     28/3/2008
 * Modified:    $Date: 2015/06/25 05:10:39 $ by $Author: didik $
 * Language:    Javascript
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Tampilkan _MENU_ Data Perhalaman",
				"sZeroRecords": "Data yang dicari tidak ada...",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" style="width:250px" />';
