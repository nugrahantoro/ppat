...
<![endif]-->
		...
		<script src="<?php echo $assetdir; ?>js/jquery.colorbox-min.js"></script>
		<!--[if lte IE 8]>
		...
		<script src="<?php echo $assetdir; ?>js/jquery.hotkeys.min.js"></script>
		<script src="<?php echo $assetdir; ?>js/bootstrap-wysiwyg.min.js"></script>
