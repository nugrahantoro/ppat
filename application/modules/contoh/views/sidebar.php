  ...
  <div class="main-container-inner">
    <div class="sidebar responsive" id="sidebar">
      ...
      <ul class="nav nav-list" style="top:0px;">
        <li class='hsub active'>
          <a href="http://localhost/ppat/index.php/menu/home" data-original-title="Home" title="" data-placement="top" data-rel="tooltip"><i class="menu-icon fa fa-home"></i><span class="menu-text">Home</span></a>
